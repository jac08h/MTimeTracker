...
class TestProcessLogsCorrect:
    def test_basic(self):
        ...
        logs_processor = LogsProcessor(DateRangeContainer('title', daterange), 'test_logs/correct')
...
class TestProcessLogsIncorrect:
    def test_hogwash(self):
        ...
        daterange = get_date_range(date, date)
        logs_processor = LogsProcessor(DateRangeContainer('title', daterange), 'test_logs/incorrect')
